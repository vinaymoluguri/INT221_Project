...
<html>
	...
	<body>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<h1>PlayOnlineGames: <span>Play Exciting Games <br />
					One The Go</span></h1>
					<ul class="actions">
						<li><a href="http://127.0.0.1:8000/login" class="button alt">Log In</a></li>
						<li><a href="http://127.0.0.1:8000/signup" class="button alt">Sign Up</a></li>
					</ul>
				</div>
			</section>
		...
		<!-- One -->
			<section id="one">
				<div class="inner">
					...
					<p>Every game here is interesting. You will love all the games. From a simple word game to a 2d game ,you will find everything here.Also create your own games and earn money.</p>
					<ul class="actions">
						<li><a href="learnmore.blade.html" class="button alt">Learn More</a></li>
					</ul>
				</div>
			</section>
				...
				<div class="inner">
					<article>
						<div class="content">
							...
							<p>In this game the player can check his luck by entering simple numbers and check weather the number is match to the computer generated number or not.</p>
						</div>
					</article>
					<article class="alt">
						<div class="content">
							...
							<p>In this game the player move the bird by overcoming all obstacles arround and make a high score</p>
						</div>
					</article>
				</div>
			</section>
				...
				<div class="inner">
					<article>
						<div class="content">
							...
							<p>Here you can submit your own game and earn money.</p>
							<ul class="actions">
					...
					<article>
						<div class="content">
							...
							<header>
								<h3>Buy All Accessories</h3>
							</header>
							<p>Don't want to waste your time buy the levels and be the king of the game.</p>
							<ul class="actions">
								<li><a href="#" class="button alt">Learn More</a></li>
							</ul>
						</div>
					...
					<div class="content">
							...
							<p>Communicate with the gamers club and play all the premium level games.</p>
							<ul class="actions">
								<li><a href="#" class="button alt">Learn More</a></li>
							</ul>
						</div>
